...
public class RelatoriosService {
	...
	private void buscaFuncionarioNomeSalarioMaiorData(Scanner scanner) {
		System.out.println("Nome Pesquisa");
		String nome = scanner.next();
		
		System.out.println("Data contratacao Pesquisa");
		String data = scanner.next();
		LocalDate locaDate = LocalDate.parse(data, formatter);
		
		System.out.println("Salario Pesquisa");
		Double salario = scanner.nextDouble();
		
		List<Funcionario> list = funcionarioRepository
				.findNomeSalarioMaiorDataContratacao(nome, salario, locaDate);
	...
	private void buscaFuncionarioDataContratacao(Scanner scanner) {
		...
		List<Funcionario> list = funcionarioRepository.findDataContratacaoMaior(locaDate);
		list.forEach(System.out::println);
